      ...
      <main className="relative flex-1 overflow-hidden flex">
        ...
        <div className="relative z-20 min-w-full min-h-full flex flex-row items-center justify-center">
          <div className="w-100 py-4 px-6 flex flex-col rounded-3xl bg-[#76B74F]">
              ...
              <h3 className="text-2xl font-bold self-center">Definir nova senha</h3>
              ...
              <div className="flex flex-col gap-2 pt-5 pb-10">
                <div className="flex flex-col gap-1">
                  <label className="text-inter text-[14px] font-semibold" htmlFor="">Nova Senha</label>
                  <input type="password" className="h-10 border border-[#404040] bg-white text-[#6C757D] rounded-lg px-1.5" placeholder="Digite sua nova senha"/>
                </div>
                <div className="flex flex-col gap-1">
                  <label className="text-inter text-[14px] font-semibold" htmlFor="">Confirmar Nova Senha</label>
                  <input type="password" className="h-10 border border-[#404040] bg-white text-[#6C757D] rounded-lg px-1.5" placeholder="Confirme sua nova senha"/>
                </div>
              </div>
